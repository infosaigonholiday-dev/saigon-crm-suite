...
const DEFAULT_PERMISSIONS: Record<string, PermissionKey[]> = {
  ...
  HCNS: ["employees.view", "employees.create", "employees.edit", "leave.view", "leave.create", "payroll.view", "payroll.create"],
  HR_MANAGER: ["employees.view", "employees.create", "employees.edit", "employees.delete", "leave.view", "leave.create", "leave.approve", "payroll.view", "payroll.create", "payroll.edit"],
  HR_HEAD: ["employees.view", "employees.create", "employees.edit", "employees.delete", "leave.view", "leave.create", "leave.approve", "payroll.view", "payroll.create", "payroll.edit", "bookings.view", "quotations.view", "payments.view"],
  KETOAN: ["customers.view", "bookings.view", "payments.view", "payments.create", "payments.edit", "payroll.view", "payroll.edit", "finance.view", "finance.edit"],
