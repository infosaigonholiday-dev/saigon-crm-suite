...
const DEFAULT_PERMISSIONS: Record<string, PermissionKey[]> = {
  ...
  HR_MANAGER: ["employees.view", "employees.create", "employees.edit", "employees.delete", "leave.view", "leave.create", "leave.approve", "payroll.view", "payroll.create", "payroll.edit", "settings.view"],
  HR_HEAD: ["employees.view", "employees.create", "employees.edit", "employees.delete", "leave.view", "leave.create", "leave.approve", "payroll.view", "payroll.create", "payroll.edit", "bookings.view", "quotations.view", "payments.view", "settings.view"],
