...
const APPROVER_ROLES = ["ADMIN", "SUPER_ADMIN", "DIRECTOR", "HR_HEAD", "HR_MANAGER", "HCNS", "MANAGER", "DIEUHAN"];
// Roles that see all requests
const FULL_VIEW_ROLES = ["ADMIN", "SUPER_ADMIN", "DIRECTOR", "HR_HEAD", "HR_MANAGER", "HCNS"];
