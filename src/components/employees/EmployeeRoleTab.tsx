...
import { Loader2, Shield, Mail, UserCheck } from "lucide-react";
...
export function EmployeeRoleTab({ employeeId, profileId }: Props) {
  const { user } = useAuth();
    ...
    return (
      <Card>
        <CardContent className="py-8 text-center text-muted-foreground">
          ...
          <p>Nhân viên chưa được liên kết tài khoản đăng nhập.</p>
          <p className="text-xs mt-1">Hãy tạo tài khoản cho nhân viên trước khi phân quyền.</p>
        </CardContent>
      </Card>
    );
  }
