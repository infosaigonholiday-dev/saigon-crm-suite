...
-- Drop and recreate the role check constraint with all roles including 6 new intern roles
ALTER TABLE public.profiles DROP CONSTRAINT IF EXISTS profiles_role_check;
ALTER TABLE public.profiles ADD CONSTRAINT profiles_role_check CHECK (
  role IN (
    'ADMIN', 'SUPER_ADMIN', 'DIRECTOR',
    'HCNS', 'HR_MANAGER', 'HR_HEAD',
...
-- Update get_default_permissions_for_role to include 6 new intern roles
