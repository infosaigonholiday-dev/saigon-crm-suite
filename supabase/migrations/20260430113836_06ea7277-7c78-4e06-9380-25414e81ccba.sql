-- Open RPC stats access to GDKD/MANAGER + add aggregated per-user stats RPC
...
BEGIN
  IF NOT (
    ...
    OR public.has_role(auth.uid(), 'GDKD'::app_role)
...
-- New: per-user stats RPC for "Tình trạng đọc theo nhân sự" section
